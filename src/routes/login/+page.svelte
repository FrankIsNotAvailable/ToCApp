...
<div class="flex min-h-screen items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
	...
	>
		<div class="text-center">
			...
			<p class="mt-3 text-sm text-[#646464] sm:mt-4 sm:text-base">
				Log in with your Google account.
			</p>
		</div>

		{#if errorMessage}
			<div class="rounded-md border border-red-200 bg-red-50 p-3 sm:p-4">
				<div class="flex">
					...
					<div class="ml-3">
						<p class="text-xs font-medium text-red-800 sm:text-sm">{errorMessage}</p>
					</div>
				</div>
			</div>
		{/if}
