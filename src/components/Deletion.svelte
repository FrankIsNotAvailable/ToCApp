...
{#if open}
	<div class="fixed inset-0 flex items-center z-50 justify-center bg-black/40 p-4 backdrop-blur-sm">
		<div
			class="flex w-full max-w-md flex-col items-center gap-4 rounded-3xl bg-white/50 px-20 py-12
